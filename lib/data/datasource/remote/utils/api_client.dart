...
import 'package:messmatebot/data/datasource/remote/utils/api_exception.dart';
...
class ApiClient {
  ...
  Future<R> _mapException<T, R>({
    ...
    try {
      ...
      throw DioExceptionMapper.mapDioException(Exception(exception));
    }
    ...
    if (kDebugMode) {
      ...
      try {
        ...
        throw DioExceptionMapper.mapParsingException(Exception(exception));
      }
    }
  }
}
